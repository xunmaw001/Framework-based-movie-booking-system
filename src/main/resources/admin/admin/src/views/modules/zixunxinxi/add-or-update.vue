<template>
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="资讯编号" prop="zixunbianhao">
					<el-input v-model="ruleForm.zixunbianhao" placeholder="资讯编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zixunbianhao" label="资讯编号" prop="zixunbianhao">
					<el-input v-model="ruleForm.zixunbianhao" placeholder="资讯编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="资讯标题" prop="zixunbiaoti">
					<el-input v-model="ruleForm.zixunbiaoti" placeholder="资讯标题" clearable  :readonly="ro.zixunbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="资讯标题" prop="zixunbiaoti">
					<el-input v-model="ruleForm.zixunbiaoti" placeholder="资讯标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="资讯类型" prop="zixunleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="资讯类型" prop="zixunleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="资讯简介" prop="zixunjianjie">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zixunjianjie" label="资讯简介" prop="zixunjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#00a9aa","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zixunjianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="资讯详情" prop="zixunxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zixunxiangqing" label="资讯详情" prop="zixunxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#00a9aa","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zixunxiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zixunxiangqing = this.ruleForm.zixunxiangqing.replace(reg,'../../../springbootwqc3k/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
